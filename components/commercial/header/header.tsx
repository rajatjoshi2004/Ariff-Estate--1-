...
import commercialHero from "../../../public/Images/commercial.jpg";

const translations = {
  en: {
    discover: "Discover Commercial Spaces",
    title: "Properties For Commercial Use",
    description:
      "Find your ideal commercial property from our extensive selection. From modern offices to retail spaces and warehouses, discover the perfect place for your business in Ethiopia's most sought-after locations.",
    propertiesCount: "Properties Listed",
    newListings: "New Listings",
    verifiedAgents: "Verified Agents",
  },
  am: {
    discover: "የንግድ ቦታዎችን ያግኙ",
    title: "ለንግድ አገልግሎት የሚሆኑ ንብረቶች",
    description:
      "ከሰፊው የንግድ ንብረቶች ስብስብ ውስጥ ተስማሚ የሆነውን ያግኙ። ከዘመናዊ ቢሮዎች እስከ የችርቻሮ መደብሮች እና መጋዘኖች፣ በኢትዮጵያ በጣም በሚፈለጉ ስፍራዎች ለንግድዎ ፍጹም የሆነውን ቦታ ያግኙ።",
