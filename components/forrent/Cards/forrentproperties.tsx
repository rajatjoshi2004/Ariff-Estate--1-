...
interface ForRentPropertiesProps {
  properties: Property[];
}

const translations = {
  en: {
    search: "Search rental properties...",
    filters: "Filters",
    sort: "Sort by",
    viewAll: "View All Properties For Rent",
    ...
    noProperties: "No rental properties found matching your criteria",
  },
  am: {
    search: "የኪራይ ንብረቶችን ይፈልጉ...",
    filters: "ማጣሪያዎች",
    sort: "አስተካክል",
    viewAll: "ሁሉንም ለኪራይ የቀረቡ ንብረቶችን ይመልከቱ",
    ...
    noProperties: "ከእርስዎ መስፈርት ጋር የሚዛመድ ምንም የኪራይ ንብረት አልተገኘም",
  },
};
...
const ForRentProperties: React.FC<ForRentPropertiesProps> = ({
  properties,
}) => {
      ...
      {displayedProperties.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {displayedProperties.map((property) => (
            <ForRentCard key={property.id} {...property} />
          ))}
        </div>
      ) : (
